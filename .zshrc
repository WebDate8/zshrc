...
alias UPD="cd && git clone https://github.com/webdate8/zshrc && cd zshrc && chmod +x update.sh && ./update.sh && cd && source .zshrc"
alias tmux-conf="cd && git clone https://github.com/webdate8/zshrc && cd zshrc && chmod +x tmux-conf.sh && ./tmux-conf.sh && cd && source .zshrc"
...
#able to run in any minimal POSIX-like environment with ncurses installed
